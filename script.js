...
const xurl = "https://script.google.com/macros/s/AKfycbx_TbjC7f3L0vZ-Dy_7qsaMGUNPnjufwFEdgnRd-a1XJaF46OtMDZG0XxfzipYtvwa_JA/exec";
...
function handleServerResponse(jsonResponse, { displayName, email, pictureUrl }) {
  ...
  Swal.fire({
    ...
    html: `${desc}<br><h3 style="color:red;"></h3>`,
    icon: 'success',
